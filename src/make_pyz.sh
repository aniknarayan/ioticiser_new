...
# To run ioticiser produced by this script:
# PYTHONPATH=path/to/archive.pyz python3 -mIoticiser

PYTHONPATH=../3rd

# Final archive name
OUT_NAME=Ioticiser.pyz
...
echo -e "\n*** Compiling Ioticiser direct dependencies"
